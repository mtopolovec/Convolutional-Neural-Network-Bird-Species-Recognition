...
class Block(nn.Module):
    def __init__(self, num_layers, in_channels, out_channels, identity_downsample=None, stride=1):
        ...
        if self.num_layers > 34:
            ...
            self.conv2 = nn.Conv2d(in_channels, out_channels, kernel_size=(3, 3), stride=(stride, stride),
                                   padding=(1, 1))
...
class ResNet(nn.Module):
    ...
    def make_layers(self, num_layers, block, num_residual_blocks, intermediate_channels, stride):
        ...
        identity_downsample = nn.Sequential(
            nn.Conv2d(self.in_channels, intermediate_channels * self.expansion, kernel_size=(1, 1), stride=stride),
...
def ResNet18(img_channels=3, num_classes=275):
    return ResNet(18, Block, img_channels, num_classes)


def ResNet34(img_channels=3, num_classes=275):
    return ResNet(34, Block, img_channels, num_classes)


def ResNet50(img_channels=3, num_classes=275):
    return ResNet(50, Block, img_channels, num_classes)


def ResNet101(img_channels=3, num_classes=275):
    return ResNet(101, Block, img_channels, num_classes)


def ResNet152(img_channels=3, num_classes=275):
